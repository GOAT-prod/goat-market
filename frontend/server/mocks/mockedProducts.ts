...
export const mockedProducts: Products = {
  items: [
    ...
    },
    {
      ...
      discountPercent: 15,
      description:
        "Стильные и удобные кроссовки для повседневного использования.",
      category: "Кроссовки",
    ...
    },
    {
      ...
      discountPercent: 20,
      description:
        "Универсальные кроссовки для тренировок с высокой прочностью.",
      category: "Кроссовки",
    ...
    },
    {
      ...
      discountPercent: 15,
      description:
        "Кроссовки с гелевой амортизацией для максимального комфорта.",
      category: "Кроссовки",
      material: "Текстиль, резина",
    ...
    },
    {
      ...
      discountPercent: 0,
      description:
        "Культовые кроссовки, созданные в сотрудничестве с Kanye West.",
      category: "Кроссовки",
      material: "Текстиль, синтетика",
    ...
    },
    {
      ...
      discountPercent: 0,
      description:
        "Кроссовки для бега с превосходной амортизацией и поддержкой.",
      category: "Кроссовки",
      material: "Текстиль, резина",
    ...
    },
    {
      ...
      discountPercent: 0,
      description:
        "Легендарные кроссовки с кожаным верхом и фирменными полосками.",
      category: "Кроссовки",
      material: "Кожа, резина",
    ...
    },
    {
      ...
      discountPercent: 15,
      description:
        "Баскетбольные кроссовки с технологией Pump для идеальной посадки.",
      category: "Кроссовки",
      material: "Кожа, резина",
    ...
    },
    {
      ...
      discountPercent: 10,
      description:
        "Культовые кроссовки с многослойной конструкцией и амортизацией Air.",
      category: "Кроссовки",
      material: "Кожа, текстиль",
